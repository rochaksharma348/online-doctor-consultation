		...
		<div id="loginbox" style="margin-top: 50px;"
			...
			<div class="panel panel-info">
				...
				<div style="padding-top: 30px" class="panel-body">
					...
					<form:form action="processLogin" modelAttribute="patientCredentials" method="POST" class="form-horizontal">
			...
			<div>
				<a href="${pageContext.request.contextPath}/patient/register" class="btn btn-primary" role="button" aria-pressed="true">Register New User</a>
			</div>
