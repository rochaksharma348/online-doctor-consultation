...
<body>
		<div id="loginbox" style="margin-top: 50px;"
			...
			<div class="panel panel-primary">
				...
				<div class="panel-heading">
					<div class="panel-title">Update Appointment</div>
				</div>
		...
		<c:url var="appointmentsLink" value="/patient/viewAppointments">
		...
		<p>
			<a href="${appointmentsLink}" class="btn btn-outline-primary">Back to appointments</a> 
		</p>
