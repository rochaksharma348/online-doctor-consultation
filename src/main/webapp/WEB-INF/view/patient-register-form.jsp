...
<body>
		<div id="loginbox" style="margin-top: 50px;"
			...
			<div class="panel panel-primary">
				...
				<div class="panel-heading">
					<div class="panel-title">Patient Registration Form</div>
				</div>
		
				<div style="padding-top: 30px" class="panel-body">
		
				<form:form action="registerPatient" modelAttribute="patient" method="POST">
		...
		<p>
			<a href="${pageContext.request.contextPath}/patient/panel" class="btn btn-outline-primary">Back to Panel</a> 
		</p>
