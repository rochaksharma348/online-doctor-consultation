...
<body>
		<div id="loginbox" style="margin-top: 50px;"
			...
			<div class="panel panel-primary">
				...
				<div class="panel-heading">
					<div class="panel-title">Doctor registration Form</div>
				</div>
		
				<div style="padding-top: 30px" class="panel-body">
		
				<form:form action="registerDoctor" modelAttribute="doctor" method="POST">
		...
		<p>
			<a href="${pageContext.request.contextPath}/doctor/panel" class="btn btn-outline-primary">Back to Panel</a> 
		</p>
